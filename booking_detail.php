...
<title>Quick Vehicle Rent</title>
<!--Bootstrap -->
...
<section class="user_profile inner_pages">
	...
	<div class="user_profile_info">	
        ...
        <form method="post" name="sewa" onSubmit="return valid();"enctype="multipart/form-data">  
            ...
            <div class="form-group">
            <label>Biaya Mobil (<?php echo isset($durasi) ? $durasi : ''; ?> Hari)</label><br/>
				<input type="text" class="form-control" name="biayamobil" value="<?php echo format_rupiah($totalmobil);?>"readonly>
            </div>
            <div class="form-group">
			<label>Biaya Driver (<?php echo isset($durasi) ? $durasi : ''; ?> Hari)</label><br/>
...
?>
<div class="form-group">
    <label>Total Biaya Sewa (<?php echo isset($durasi) ? $durasi : ''; ?> Hari)</label><br/>
...
<?php 
    if($result['status']=="Menunggu Pembayaran"){
        ...
        if ($resultrek) {
?>
<b>*Silahkan transfer total biaya sewa ke <?php echo $resultrek['detail'];?> maksimal tanggal <?php echo IndonesiaTgl($tglhasil);?>.</b>
<?php
        } 
    }
} 
