								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										$sqlsewa = "SELECT booking.*,mobil.*,merek.*,users.* FROM booking,mobil,merek,users WHERE booking.id_mobil=mobil.id_mobil
													AND merek.id_merek=mobil.id_merek AND users.email=booking.email AND status='Menunggu Pembayaran'
										...
										<tr align="center">
											...
											<a href="sewaeditbayar.php?id=<?php echo $result['kode_booking'];?>"><i class="fa fa-edit"></i></a></td>
										</tr>
										<?php }?>
									</tbody>
								</table>
