				...
				<tbody>
					<tr>
						<td rowspan="3" width="16%" class="text-center">
							<img src="../assets/images/quick vehicle rent.png" alt="logo" width="80" />
						</td>
					...
					<tr>
						<td class="text-center">Komp. Permata Biru Blok F No.69, RT.06, RW.19, Cinunuk, Kec. cileunyi, Kab. Bandung, Jawa Barat</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
